...
namespace ISPAddressChecker.Helpers
{
    ...
    {
        public static bool MandatoryConfigurationChecks(EmailSettingsOptions emailSettingsOptions, APIApplicationSettingsOptions applicationSettingOptions, ILogger logger)
        {
        ...
        public static ConfigErrorReportModel DefaultSettingsCheck(APIEmailSettingsOptions emailSettingsOptions, APIApplicationSettingsOptions applicationSettingsOptions, ILogger logger)
        {
